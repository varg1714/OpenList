...
func (y *Cloud189PC) BatchMove(ctx context.Context, srcDir model.Obj, srcObjs []model.Obj, dstDir model.Obj, args model.BatchArgs) error {
...
func (y *Cloud189PC) BatchCopy(ctx context.Context, srcDir model.Obj, srcObjs []model.Obj, dstDir model.Obj, args model.BatchArgs) error {
	isFamily := y.isFamily()
	other := map[string]string{"targetFileName": dstDir.GetName()}
